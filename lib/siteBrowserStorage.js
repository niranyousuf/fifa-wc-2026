...
export const SITE_SESSION_STORAGE_KEYS = [
  {
    key: "wc2026_visitor_counted",
    purpose:
      "Marks that this browser tab already incremented the public visitor counter (avoids double-count on refresh)",
    ttl: "Until you close the tab",
  },
];
